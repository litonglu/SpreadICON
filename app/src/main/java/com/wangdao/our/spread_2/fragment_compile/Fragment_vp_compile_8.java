 ...
 */
public class Fragment_vp_compile_8 extends Fragment{
    ...
    private fcHandler_8 fhandler_8 = new fcHandler_8();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.vp_compile_page8, null);
    ...
    private void initData(){
        ...
        params.add(new BasicNameValuePair("keywordtags",sharedPreferences.getString("tag7","")));
    ...
    private void initView(){
        ll_nowifi = (LinearLayout) myView.findViewById(R.id.vp_compile_page8_ll_nowifi);
        pull_ScrollView = (PullToRefreshScrollView) myView.findViewById(R.id.vp_compile_page8_scrollview);
        myListView = (ListView) myView.findViewById(R.id.vp_compile_page8_pull);
        tvnull = (TextView) myView.findViewById(R.id.vp_compile_page8_tvnull);
    }
