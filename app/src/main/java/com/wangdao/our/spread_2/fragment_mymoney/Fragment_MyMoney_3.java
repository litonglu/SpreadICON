 ...
 * 我的佣金-已领取
 */
public class Fragment_MyMoney_3 extends Fragment{
    ...
    private FM3_Handler fm3_handler = new FM3_Handler();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.fragment_mymoey_3,null);
    ...
    private void initView(){
        tv_erro = (TextView) myView.findViewById(R.id.fragment_mymoney_3_tv_erro);
        lv_fm2 = (ListView) myView.findViewById(R.id.fragment_mymoney_3_lv);
    }
    ...
    private void initData(){
        ...
        params.add(new BasicNameValuePair("type", "used"));
                ...
                try {
                    ...
                    if (httpResponse.getStatusLine().getStatusCode() == 200) {
                        ...
                        if(jo.getString("status").equals("1")){
                            ...
                            fm3_handler.sendEmptyMessage(12);
                        }
                    }
    ...
    class FM3_Handler extends Handler{
        @Override
