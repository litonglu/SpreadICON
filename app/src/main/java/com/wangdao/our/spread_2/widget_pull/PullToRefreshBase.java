...
import com.wangdao.our.spread_2.widget_pull.RotateLoadingLayout;
import com.wangdao.our.spread_2.widget_pull.Utils;


public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements com.wangdao.our.spread_2.widget_pull.IPullToRefresh<T> {
	...
	private com.wangdao.our.spread_2.widget_pull.LoadingLayout mHeaderLayout;
	private com.wangdao.our.spread_2.widget_pull.LoadingLayout mFooterLayout;
	...
	@Override
	public final com.wangdao.our.spread_2.widget_pull.ILoadingLayout getLoadingLayoutProxy() {
		return getLoadingLayoutProxy(true, true);
	}

	@Override
	public final com.wangdao.our.spread_2.widget_pull.ILoadingLayout getLoadingLayoutProxy(boolean includeStart, boolean includeEnd) {
	...
	public final boolean isPullToRefreshOverScrollEnabled() {
		return VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD && mOverScrollEnabled
				&& com.wangdao.our.spread_2.widget_pull.OverscrollHelper.isAndroidOverScrollEnabled(mRefreshableView);
	}
...
//		}
	...
	protected com.wangdao.our.spread_2.widget_pull.LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		com.wangdao.our.spread_2.widget_pull.LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
	 ...
	 */
	protected com.wangdao.our.spread_2.widget_pull.LoadingLayoutProxy createLoadingLayoutProxy(final boolean includeStart, final boolean includeEnd) {
		com.wangdao.our.spread_2.widget_pull.LoadingLayoutProxy proxy = new com.wangdao.our.spread_2.widget_pull.LoadingLayoutProxy();
	...
	protected final com.wangdao.our.spread_2.widget_pull.LoadingLayout getFooterLayout() {
	...
	protected final com.wangdao.our.spread_2.widget_pull.LoadingLayout getHeaderLayout() {
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			com.wangdao.our.spread_2.widget_pull.ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View.LAYER_TYPE_HARDWARE
	...
	public static enum AnimationStyle {
		...
		com.wangdao.our.spread_2.widget_pull.LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
					return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
				case FLIP:
					return new com.wangdao.our.spread_2.widget_pull.FlipLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
