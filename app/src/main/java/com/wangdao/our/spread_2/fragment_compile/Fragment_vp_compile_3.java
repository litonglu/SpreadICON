...
public class Fragment_vp_compile_3 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.vp_compile_page3, null);
    ...
    private void initData(){
        ...
        params.add(new BasicNameValuePair("keywordtags",sharedPreferences.getString("tag2","")));
...
//                        }
    ...
    private void initView(){
        pull_ScrollView = (PullToRefreshScrollView) myView.findViewById(R.id.vp_compile_page3_scrollview);
        myListView = (ListView) myView.findViewById(R.id.vp_compile_page3_pull);
        tvnull = (TextView) myView.findViewById(R.id.vp_compile_page3_tvnull);
    }
