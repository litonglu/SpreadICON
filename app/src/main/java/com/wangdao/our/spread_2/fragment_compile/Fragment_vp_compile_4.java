 ...
 */
public class Fragment_vp_compile_4 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.vp_compile_page4, null);
    ...
    private void initData(){
        ...
        params.add(new BasicNameValuePair("keywordtags",sharedPreferences.getString("tag3","")));
                ...
                try {
                    ...
                    if (httpResponse.getStatusLine().getStatusCode() == 200) {
                        ...
                        if(jo.getString("status").equals("1")){
                            ...
                            fhandler_4.sendEmptyMessage(1);
                        }else{
                            fhandler_4.sendEmptyMessage(2);
                        }
                    }
                } catch (Exception e) {
                    fhandler_4.sendEmptyMessage(2);
    ...
    class fcHandler_4 extends Handler {
        @Override
    ...
    private void initView(){
        pull_ScrollView = (PullToRefreshScrollView) myView.findViewById(R.id.vp_compile_page4_scrollview);
        myListView = (ListView) myView.findViewById(R.id.vp_compile_page4_pull);
        tvnull = (TextView) myView.findViewById(R.id.vp_compile_page4_tvnull);
    }
