...
public class demo extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        wechatButton.setOnClickListener(demo.this);
        alipayButton.setOnClickListener(demo.this);
        upmpButton.setOnClickListener(demo.this);
        bfbButton.setOnClickListener(demo.this);
        jdpayButton.setOnClickListener(demo.this);
    ...
    class PaymentTask extends AsyncTask<PaymentRequest, Void, String> {
        ...
        protected void onPostExecute(String data) {
            ...
            Log.d("charge", data);
            Pingpp.createPayment(demo.this, data);
        }
    }
