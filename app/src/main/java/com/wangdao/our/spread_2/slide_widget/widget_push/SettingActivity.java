...
public class SettingActivity extends InstrumentedActivity implements OnClickListener {
   ...
   @Override
    ...
    private void initData(){
	  mSettings = getSharedPreferences(com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.PREFS_NAME, MODE_PRIVATE);
	  String days = mSettings.getString(com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.PREFS_DAYS, "");
	  ...
	  int startTimeStr = mSettings.getInt(com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.PREFS_START_TIME, 0);
	  startTime.setCurrentHour(Integer.valueOf(startTimeStr));
	  int endTimeStr = mSettings.getInt(com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.PREFS_END_TIME, 23);
	...
	private void setPushTime(){
		...
		mEditor.putString(com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.PREFS_DAYS, daysSB.toString());
		mEditor.putInt(com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.PREFS_START_TIME, startime);
		mEditor.putInt(com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.PREFS_END_TIME, endtime);
		mEditor.commit();
