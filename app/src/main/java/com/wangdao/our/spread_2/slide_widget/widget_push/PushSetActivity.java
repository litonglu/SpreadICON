...
import com.wangdao.our.spread_2.slide_widget.widget_push.SettingActivity;
...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	private void setTag(){
		...
		for (String sTagItme : sArray) {
			if (!com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.isValidTagAndAlias(sTagItme)) {
	...
	private void setAlias(){
		...
		if (!com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.isValidTagAndAlias(alias)) {
			Toast.makeText(PushSetActivity.this,R.string.error_tag_gs_empty, Toast.LENGTH_SHORT).show();
			return;
		}
	...
	private final TagAliasCallback mAliasCallback = new TagAliasCallback() {
        ...
        public void gotResult(int code, String alias, Set<String> tags) {
            ...
            case 6002:
                ...
                Log.i(TAG, logs);
                if (com.wangdao.our.spread_2.slide_widget.widget_push.ExampleUtil.isConnected(getApplicationContext())) {
