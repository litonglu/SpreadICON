 ...
 */
public class Fragment_vp_compile_9 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.vp_compile_page9, null);
    ...
    private void initView(){
        ...
        pull_ScrollView = (PullToRefreshScrollView) myView.findViewById(R.id.vp_compile_page9_scrollview);
        myListView = (ListView) myView.findViewById(R.id.vp_compile_page9_pull);
        tvnull = (TextView) myView.findViewById(R.id.vp_compile_page9_tvnull);
    }
