...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener {
	...
	private com.wangdao.our.spread_2.widget_pull.IndicatorLayout mIndicatorIvTop;
	private com.wangdao.our.spread_2.widget_pull.IndicatorLayout mIndicatorIvBottom;
	...
	public final void setEmptyView(View newEmptyView) {
		...
		if (mRefreshableView instanceof com.wangdao.our.spread_2.widget_pull.EmptyViewMethodAccessor) {
			((com.wangdao.our.spread_2.widget_pull.EmptyViewMethodAccessor) mRefreshableView).setEmptyViewInternal(newEmptyView);
		} else {
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			mIndicatorIvTop = new com.wangdao.our.spread_2.widget_pull.IndicatorLayout(getContext(), Mode.PULL_FROM_START);
		...
		if (mode.showFooterLoadingLayout() && null == mIndicatorIvBottom) {
			// If the mode can pull down, and we don't have one set already
			mIndicatorIvBottom = new com.wangdao.our.spread_2.widget_pull.IndicatorLayout(getContext(), Mode.PULL_FROM_END);
			FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
					ViewGroup.LayoutParams.WRAP_CONTENT);
			params.rightMargin = getResources().getDimensionPixelSize(R.dimen.indicator_right_padding);
