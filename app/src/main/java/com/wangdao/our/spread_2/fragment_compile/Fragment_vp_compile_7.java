 ...
 */
public class Fragment_vp_compile_7 extends Fragment{
    ...
    private fcHandler_7 fhandler_7 = new fcHandler_7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.vp_compile_page7, null);
    ...
    private void initData(){
        ...
        params.add(new BasicNameValuePair("keywordtags",sharedPreferences.getString("tag6","")));
                ...
                try {
                    ...
                    if (httpResponse.getStatusLine().getStatusCode() == 200) {
                        ...
                        if(jo.getString("status").equals("1")){
                            ...
                            fhandler_7.sendEmptyMessage(1);
                        }else{
                            fhandler_7.sendEmptyMessage(2);
                        }
                    }
                } catch (Exception e) {
                    fhandler_7.sendEmptyMessage(2);
    ...
    class fcHandler_7 extends Handler {
        @Override
    ...
    private void initView(){
        pull_ScrollView = (PullToRefreshScrollView) myView.findViewById(R.id.vp_compile_page7_scrollview);
        myListView = (ListView) myView.findViewById(R.id.vp_compile_page7_pull);
        tvnull = (TextView) myView.findViewById(R.id.vp_compile_page7_tvnull);
    }
