 ...
 */
public class Fragment_vp_compile_2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.vp_compile_page2, null);
    ...
    class fcHandler_2 extends Handler {
        @Override
    ...
    private void initView(){
        ...
        myListView = (ListView) myView.findViewById(R.id.vp_compile_page2_pull);
        tvnull = (TextView) myView.findViewById(R.id.vp_compile_page2_tvnull);
    }
