 ...
 */
public class Fragment_vp_compile_5 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.vp_compile_page5, null);
    ...
    private void initData(){
        ...
        params.add(new BasicNameValuePair("keywordtags",sharedPreferences.getString("tag4","")));
...
//                        }
    ...
    class fcHandler_5 extends Handler {
        @Override
    ...
    private void initView(){
        pull_ScrollView = (PullToRefreshScrollView) myView.findViewById(R.id.vp_compile_page5_scrollview);
        myListView = (ListView) myView.findViewById(R.id.vp_compile_page5_pull);
        tvnull = (TextView) myView.findViewById(R.id.vp_compile_page5_tvnull);
    }
